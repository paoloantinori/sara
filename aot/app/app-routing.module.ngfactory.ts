...
import * as import9 from './components/catalog/catalog.component.ngfactory';
...
import * as import13 from '../../app/components/catalog/catalog.component';
...
class AppRoutingModuleInjector extends import0.NgModuleInjector<import1.AppRoutingModule> {
  ...
  get _LocationStrategy_4():any {
    if ((this.__LocationStrategy_4 == (null as any))) { (this.__LocationStrategy_4 = import2.provideLocationStrategy(this.parent.get(import10.PlatformLocation),this.parent.get(import11.APP_BASE_HREF,(null as any)),this._ROUTER_CONFIGURATION_3)); }
  ...
  get _NgModuleFactoryLoader_8():import6.SystemJsNgModuleLoader {
    if ((this.__NgModuleFactoryLoader_8 == (null as any))) { (this.__NgModuleFactoryLoader_8 = new import6.SystemJsNgModuleLoader(this.parent.get(import12.Compiler),this.parent.get(import6.SystemJsNgModuleLoaderConfig,(null as any)))); }
  ...
  get _ROUTES_9():any[] {
      if ((this.__ROUTES_9 == (null as any))) { (this.__ROUTES_9 = [[
        ...
        {
          path: 'wanted',
          component: import13.WantedComponent
        }
        ,
        {
          path: 'my',
  ...
  get _Router_10():any {
    if ((this.__Router_10 == (null as any))) { (this.__Router_10 = import2.setupRouter(this.parent.get(import14.ApplicationRef),this._UrlSerializer_6,this._RouterOutletMap_7,this._Location_5,this,this._NgModuleFactoryLoader_8,this.parent.get(import12.Compiler),this._ROUTES_9,this._ROUTER_CONFIGURATION_3,this.parent.get(import15.UrlHandlingStrategy,(null as any)))); }
  ...
  get _APP_BOOTSTRAP_LISTENER_16():any[] {
    if ((this.__APP_BOOTSTRAP_LISTENER_16 == (null as any))) { (this.__APP_BOOTSTRAP_LISTENER_16 = [import2.initialRouterNavigation(this._Router_10,this.parent.get(import14.ApplicationRef),this._RouterPreloader_14,this._ROUTER_CONFIGURATION_3)]); }
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import20.APP_BOOTSTRAP_LISTENER)) { return this._APP_BOOTSTRAP_LISTENER_16; }
